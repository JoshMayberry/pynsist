...
class InstallerBuilder(object):
    ...
    def __init__(self, appname, version, shortcuts, *, publisher=None,
                icon=DEFAULT_ICON, packages=None, packages_extraPath=None, packages_ignorePath=None, 
                extra_files=None, py_version=DEFAULT_PY_VERSION, py_bitness=DEFAULT_BITNESS,
        ...
        self.packages_ignorePath = packages_ignorePath or {}
...
"""
    ...
    def prepare_packages(self):
        ...
        copy_modules(self.packages, build_pkg_dir, 
            packages_extraPath=self.packages_extraPath, packages_ignorePath=self.packages_ignorePath,
